...
/**
 * Servlet implementation class FirstSample
 */
@WebServlet("/FirstSample")
public class FirstSample extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("Servlet is in service mode");
